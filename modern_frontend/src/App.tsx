      ...
      <main className="workspace">
        <header className="topbar">
          ...
          <div className="topbar-actions">
            <button className="global-search" type="button"><Search size={16} /><span>{t("app.search")}</span><kbd>Ctrl K</kbd></button>
        ...
        <div className="page-content">
          <Suspense fallback={<div className="page-loading">{t("common.loadingView")}</div>}>
