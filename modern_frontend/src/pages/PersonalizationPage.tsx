...
const WALLPAPER_POSITION_LABELS = { center: "personalization.positionCenter", "top-left": "personalization.positionTopLeft", "top-right": "personalization.positionTopRight", "bottom-left": "personalization.positionBottomLeft", "bottom-right": "personalization.positionBottomRight" } as const;
const WALLPAPER_SIZE_LABELS = { cover: "personalization.sizeCover", contain: "personalization.sizeContain", stretch: "personalization.sizeStretch", original: "personalization.sizeOriginal" } as const;
