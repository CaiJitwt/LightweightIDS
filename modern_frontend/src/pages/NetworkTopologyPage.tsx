      ...
      <div className="topology-workspace">
        <div className="topology-stage">
          ...
          <div className="topology-canvas-wrap">
            ...
            {nodes.length ? <svg className="topology-canvas" viewBox={`0 0 ${VIEWBOX_WIDTH} ${VIEWBOX_HEIGHT}`} preserveAspectRatio="xMidYMid meet" aria-label={t("topology.legendTitle")}>
              <defs>
