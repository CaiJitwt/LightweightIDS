...
export function TrafficPage() {
  ...
  return (
    <div className="page-stack traffic-workspace">
      ...
      {(actionError || filterNotice || pcapNotice || !serviceReady) && <p className={`capture-notice ${actionError || pcapImport.error ? "error" : ""}`}>{!serviceReady && <WifiOff size={15} />}{actionError || pcapNotice || filterNotice || "Start `python -m modern_ui.local_api` to use the live capture controls. Demo records remain available offline."}</p>}
